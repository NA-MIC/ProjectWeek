...
**2. Immitation Leaening Policy Training**
...
(2) Inference strut lengths.  
(3) Perform forward kinematics by the lengths and update the robot's pose and views.    
(4) Return to (1) and iterate until reduction is finishied.  
...
[2] R. Cadene, S. Alibert, A. Soare, Q. Gallouédec, A. Zouitine, T. Wolf, et al., "LeRobot: State-of-the-art Machine Learning for Real-World Robotics in PyTorch," 2024. [Online].
