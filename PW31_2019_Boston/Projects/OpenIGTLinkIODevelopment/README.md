...
Updated the [IGSIO web page](http://igsio.github.io/) with a short description of the current standard for sending ultrasound sector information as meta data in OpenIGTLink image messages, as well as the current format for set/get ultrasound parameter command messages.
