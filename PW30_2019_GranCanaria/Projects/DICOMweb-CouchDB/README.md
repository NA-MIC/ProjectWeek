...
1. Review and define project ideas
    ...
    1. Pick a nice web server infastructure that can easily implement rest api proxies (maybe build on [express/poouchdb-server](https://github.com/pouchdb/pouchdb-server)
