...
4. Change the format of the tooltip to make it look nicer and have it include the current image id.
5. Add a Help section at bottom, to let users know what buttons and actions do what.
6. optimize performance, if time is permitting. 
